    ...
    public static class Robot
    {
        ...
        */
        ...
        public static void KeyEvent(bool pressed, int key)
        {
            ...
            {
                var sCode = "";
                var localKeyCode = keysym.toVKCode(key);
                if (localKeyCode != null)
                {
                    ...
                    try
                    {
                        if (pressed)
                        {
                            if ((localKeyCode.key == (int) _KeyEvent.VK_SHIFT) ||
                                (localKeyCode.key == (int) _KeyEvent.VK_LSHIFT) ||
                                (localKeyCode.key == (int) _KeyEvent.VK_RSHIFT))
                                shift = true;
                            if ((localKeyCode.key == (int) _KeyEvent.VK_MENU) ||
                                (localKeyCode.key == (int) _KeyEvent.VK_LMENU) ||
                                (localKeyCode.key == (int) _KeyEvent.VK_RMENU))
                                alt = true;
                            if ((localKeyCode.key == (int) _KeyEvent.VK_CONTROL) ||
                                (localKeyCode.key == (int) _KeyEvent.VK_LCONTROL) ||
                                (localKeyCode.key == (int) _KeyEvent.VK_RCONTROL))
                                ctrl = true;
                        }
                        else
                        {
        ...
        */
        ...
        private static class keysym
        {
            ...
            public static int toVK(int keysym)
            {
                ...
                {
                    case BackSpace:
                        return (int) _KeyEvent.VK_BACK;
                    case Tab:
                        return (int) _KeyEvent.VK_TAB;

                    case Clear:
                        return (int) _KeyEvent.VK_CLEAR;
                    case Return:
                        return (int) _KeyEvent.VK_RETURN;
                    case Pause:
                        return (int) _KeyEvent.VK_PAUSE;
                    case ScrollLock:
                        return (int) _KeyEvent.VK_SCROLL;

                    case Escape:
                        return (int) _KeyEvent.VK_ESCAPE;

                    case Delete:
                        return (int) _KeyEvent.VK_DELETE;

                    case Home:
                        return (int) _KeyEvent.VK_HOME;
                    case Left:
                        return (int) _KeyEvent.VK_LEFT;
                    case Up:
                        return (int) _KeyEvent.VK_UP;
                    case Right:
                        return (int) _KeyEvent.VK_RIGHT;
                    case Down:
                        return (int) _KeyEvent.VK_DOWN;
                    case PageUp:
                        return (int) _KeyEvent.VK_PRIOR;
                    case PageDown:
                        return (int) _KeyEvent.VK_NEXT;
                    case End:
                        return (int) _KeyEvent.VK_END;
                    case Print:
                        return (int) _KeyEvent.VK_SNAPSHOT;

                    case Insert:
                        return (int) _KeyEvent.VK_INSERT;

                    //case Cancel: return (int)_KeyEvent.VK_CANCEL;
                    case Help:
                        return (int) _KeyEvent.VK_HELP;

                    case NumLock:
                        return (int) _KeyEvent.VK_NUMLOCK;

                    case KpSpace:
                        return (int) _KeyEvent.VK_SPACE;
                    case KpTab:
                        return (int) _KeyEvent.VK_TAB;
                    case KpEnter:
                        return (int) _KeyEvent.VK_RETURN;
                    ...
                    case KpDown:
                        return (int) _KeyEvent.VK_DOWN;
                    case KpPageUp:
                        return (int) _KeyEvent.VK_PRIOR; // = KpPrior
                    case KpPageDown:
                        return (int) _KeyEvent.VK_NEXT; // = KpNext
                    case KpEnd:
                        return (int) _KeyEvent.VK_END;
                    ...
                    case KpMultiply:
                        return (int) _KeyEvent.VK_MULTIPLY;
                    case KpAdd:
                        return (int) _KeyEvent.VK_ADD;
                    case KpSeparator:
                        return (int) _KeyEvent.VK_SEPARATOR; // Sun should spellcheck...
                    case KpSubtract:
                        return (int) _KeyEvent.VK_SUBTRACT;
                    case KpDecimal:
                        return (int) _KeyEvent.VK_DECIMAL;
                    case KpDivide:
                        return (int) _KeyEvent.VK_DIVIDE;

                    case KpF1:
                        return (int) _KeyEvent.VK_F1;
                    case KpF2:
                        return (int) _KeyEvent.VK_F2;
                    case KpF3:
                        return (int) _KeyEvent.VK_F3;
                    case KpF4:
                        return (int) _KeyEvent.VK_F4;

                    case Kp0:
                        return (int) _KeyEvent.VK_NUMPAD0;
                    case Kp1:
                        return (int) _KeyEvent.VK_NUMPAD1;
                    case Kp2:
                        return (int) _KeyEvent.VK_NUMPAD2;
                    case Kp3:
                        return (int) _KeyEvent.VK_NUMPAD3;
                    case Kp4:
                        return (int) _KeyEvent.VK_NUMPAD4;
                    case Kp5:
                        return (int) _KeyEvent.VK_NUMPAD5;
                    case Kp6:
                        return (int) _KeyEvent.VK_NUMPAD6;
                    case Kp7:
                        return (int) _KeyEvent.VK_NUMPAD7;
                    case Kp8:
                        return (int) _KeyEvent.VK_NUMPAD8;
                    case Kp9:
                        return (int) _KeyEvent.VK_NUMPAD9;
                    ...
                    case F4:
                        return (int) _KeyEvent.VK_F4;
                    case F5:
                        return (int) _KeyEvent.VK_F5;
                    case F6:
                        return (int) _KeyEvent.VK_F6;
                    case F7:
                        return (int) _KeyEvent.VK_F7;
                    case F8:
                        return (int) _KeyEvent.VK_F8;
                    case F9:
                        return (int) _KeyEvent.VK_F9;
                    case F10:
                        return (int) _KeyEvent.VK_F10;
                    case F11:
                        return (int) _KeyEvent.VK_F11;
                    case F12:
                        return (int) _KeyEvent.VK_F12;
                    case F13:
                        return (int) _KeyEvent.VK_F12;
                    case F14:
                        return (int) _KeyEvent.VK_F12;
                    ...
                    case CapsLock:
                        return (int) _KeyEvent.VK_CAPITAL;
            ...
            public static KeyCode toVKCode(int key)
            {
                ...
                else if (key == 32 || ((key >= 58) && (key <= 64)) || (key == 8364) || ((key >= 65360) && (key <= 65367)) ||
                         (key == 65535))
                {
                    i = key;
                    chk = true;
            ...
            public static int toVKall(int keysym)
            {
                ...
                {
                    case ShiftL:
                        return (int) _KeyEvent.VK_LSHIFT;
                    case ShiftR:
                        return (int) _KeyEvent.VK_RSHIFT;
                    case ControlL:
                        return (int) _KeyEvent.VK_LCONTROL;
                    case ControlR:
                        return (int) _KeyEvent.VK_RCONTROL;
                    case AltL:
                        return (int) _KeyEvent.VK_LMENU;
                    case AltR:
                        return (int) _KeyEvent.VK_RMENU;
                    default:
                        return 0;
                }
            }
